...
EpanetUnitConverter::EpanetUnitConverter(const int flow_units, int headloss_formula) {
    ...
    const bool is_si = (flow_units == EN_LPS || flow_units == EN_LPM || flow_units == EN_CMH || flow_units == EN_CMD ||
                        flow_units == EN_MLD || flow_units == EN_CMS);
    ...
    case EN_LPS:
        ...
        break;
    case EN_LPM:
        flow_factor_ = 1e-3 / 60.0;
        break;
    case EN_CMH:
        flow_factor_ = 1.0 / 3600.0;
        break;
    case EN_CMD:
        flow_factor_ = 1.0 / 86400.0;
        break;
    case EN_MLD:
        flow_factor_ = (1000.0 / 86400.0);
        break;
    case EN_GPM:
        flow_factor_ = 0.0000630902;
        break;
    case EN_CFS:
        flow_factor_ = 0.0283168;
        break;
    case EN_MGD:
        flow_factor_ = 0.043812636;
        break;
    case EN_IMGD:
        flow_factor_ = 0.0526168;
        break;
    case EN_AFD:
        flow_factor_ = 0.01427641;
        break;
    default:
