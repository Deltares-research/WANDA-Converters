 ...
 *
 * Determines conversion factors based on the EPAnet flow unit system and
 * headloss formula, then applies them to length, diameter, flow, and roughness
 * values.
 *
 * @param flow_units       EPAnet flow units code (e.g. EN_LPS, EN_GPM).
 * @param headloss_formula EPAnet headloss formula code (e.g. EN_HW, EN_DW,
 * EN_CM).
 */
