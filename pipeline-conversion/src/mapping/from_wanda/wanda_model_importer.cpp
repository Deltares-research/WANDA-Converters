...
WandaModelImporter::WandaModelImporter(const std::string &model_file, const std::string &wanda_bin)
    : wanda_model_in(model_file, wanda_bin) {}

WandaModelImporter::~WandaModelImporter() { wanda_model_in.close(); }
