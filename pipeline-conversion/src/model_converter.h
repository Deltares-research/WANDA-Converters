...
/**
 * @brief Top-level converter that reads a pipeline model from one format and
 ...
 * @param input_model_type Type of the source model (e.g. "WANDA", "EPAnet",
 * "GIS").
 *
 * Methods:
 * - convert(output_file, output_model_type): Exports the loaded network to the
 * target format.
 *   @param output_file       Path to the destination model file.
 *   @param output_model_type Type of the target model (e.g. "WANDA", "EPAnet",
 * "GIS").
 */
